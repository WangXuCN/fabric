...
in terms of the MSP identifiers of organizations, see `KeyEndorsementPolicy <https://godoc.org/github.com/SmartBFT-Go/fabric-chaincode-go/pkg/statebased#KeyEndorsementPolicy>`_:
