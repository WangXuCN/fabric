...
A set of `shim APIs <https://godoc.org/github.com/SmartBFT-Go/fabric-chaincode-go/shim>`_
...
``transient`` field by calling the `GetTransient() API <https://godoc.org/github.com/SmartBFT-Go/fabric-chaincode-go/shim#ChaincodeStub.GetTransient>`_.
...
.. note:: If you would like more granular access control, you can set
          ...
          `chaincode library <https://godoc.org/github.com/SmartBFT-Go/fabric-chaincode-go/shim#ChaincodeStub.GetCreator>`__ .
