...
If Go is used as a chaincode language, the [client identity chaincode library](https://github.com/SmartBFT-Go/fabric-chaincode-go/blob/{BRANCH}/pkg/cid/README.md)
