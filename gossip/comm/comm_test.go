...
import (
	...
	"github.com/SmartBFT-Go/fabric/gossip/api/mocks"
	gmocks "github.com/SmartBFT-Go/fabric/gossip/comm/mocks"
...
func (*naiveSecProvider) VerifyHeader(channelID string, signedBlock *cb.Block) error {
	return nil
}
