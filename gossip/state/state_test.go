...
import (
	...
	"github.com/SmartBFT-Go/fabric/core/mocks/validator"
	...
	"github.com/SmartBFT-Go/fabric/gossip/gossip/channel"
	"github.com/SmartBFT-Go/fabric/gossip/metrics"
	"github.com/SmartBFT-Go/fabric/gossip/privdata"
	capabilitymock "github.com/SmartBFT-Go/fabric/gossip/privdata/mocks"
	"github.com/SmartBFT-Go/fabric/gossip/protoext"
	"github.com/SmartBFT-Go/fabric/gossip/state/mocks"
	gossiputil "github.com/SmartBFT-Go/fabric/gossip/util"
	gutil "github.com/SmartBFT-Go/fabric/gossip/util"
...
func (*cryptoServiceMock) VerifyHeader(channelID string, signedBlock *pcomm.Block) error {
	return nil
}
