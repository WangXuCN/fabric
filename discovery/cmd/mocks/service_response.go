...
import discovery "github.com/SmartBFT-Go/fabric/discovery/client"
import fabric_protos_godiscovery "github.com/SmartBFT-Go/fabric-protos-go/v2/discovery"
...
func (_m *ServiceResponse) Raw() *fabric_protos_godiscovery.Response {
	...
	var r0 *fabric_protos_godiscovery.Response
	if rf, ok := ret.Get(0).(func() *fabric_protos_godiscovery.Response); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*fabric_protos_godiscovery.Response)
		}
	}
